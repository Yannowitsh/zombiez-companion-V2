...
implements Module {
    ...
    public String description() {
        return class_2561.method_43471((String)"zombiezcompanion.module.stats.desc").getString();
    }
    ...
    public static void onLocalPickup(class_1799 stack, int amount) {
    }

    private void scanGroundItems(class_310 client) {
        if (this.configManager == null || client.field_1724 == null || client.field_1687 == null) {
            return;
        }
        for (class_1297 e : client.field_1687.method_18112()) {
            ...
            if (e.method_5858((class_1297)client.field_1724) > 256.0 || !this.seenItemUuids.add(id = e.method_5667()) || (stack = item.method_6983()) == null || stack.method_7960() || DropClassifier.isGadget(name = stack.method_7964().getString()) || DropClassifier.isFood(name)) continue;
            this.trackStat(DropClassifier.rarityOf(stack), stack.method_7947());
        }
    ...
    private void readSidebar(class_310 client, long now) {
        class_269 sb = client.field_1687.method_8428();
        if (sb == null) {
            return;
        }
        ...
        if (obj != null) {
            ...
            for (class_9011 e : sb.method_1184(obj)) {
                if (e.method_55387() == null) continue;
                class_268 team = sb.method_1164(e.comp_2127());
                String line = (team != null ? class_268.method_1142((class_270)team, (class_2561)e.method_55387()) : e.method_55387().method_27661()).getString();
                dump.append("\n  ").append(line);
