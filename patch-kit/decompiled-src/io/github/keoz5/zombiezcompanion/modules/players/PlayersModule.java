...
implements Module {
    ...
    public String description() {
        return class_2561.method_43471((String)"zombiezcompanion.module.players.desc").getString();
    }
    ...
    public void onClientTick(class_310 client) {
        ...
        boolean bl = onServer = client.field_1724 != null && client.field_1687 != null && ZombieZDetector.isOnZombieZ();
        if (!onServer) {
    ...
    private void sendLeaderboard(class_310 client) {
        String name;
        ...
        if ((name = NIV_SUFFIX_RE.matcher(disp).replaceAll("").trim()).isBlank()) {
            name = client.field_1724.method_5477().getString();
        }
    ...
    private static String tabDisplayName(class_310 client) {
        try {
            String disp;
            class_640 entry;
            class_634 nh = client.method_1562();
            if (nh != null && (entry = nh.method_2871(client.field_1724.method_5667())) != null && entry.method_2971() != null && !(disp = entry.method_2971().getString().replaceAll("\u00a7.", "").trim()).isBlank()) {
                return disp;
            }
        }
        ...
        return client.field_1724.method_5477().getString();
    }
    ...
    private void sendPresence(class_310 client) {
        if (client.field_1724 == null) {
            return;
        }
        String body = String.format(Locale.ROOT, "{\"uuid\":\"%s\",\"name\":\"%s\",\"server\":\"%s\",\"x\":%.1f,\"z\":%.1f,\"modVersion\":\"%s\"}", PlayersModule.escape(this.selfUuid()), PlayersModule.escape(client.field_1724.method_5477().getString()), SERVER_KEY, client.field_1724.method_23317(), client.field_1724.method_23321(), PlayersModule.escape(PlayersModule.modVersion()));
